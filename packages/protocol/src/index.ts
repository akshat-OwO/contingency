...
import { BrowserIdentity, browserIdentityFor } from "./browser-identity.ts";
...
export type { ProfileIdentity } from "./browser-identity.ts";
...
export interface UserAgentProfile {
  ...
  /**
   * Whether Create View offers this identity for new work. Safari and Firefox
   * profiles are not selectable: Chromium can only wear their string, never
   * reproduce their engine, and promising otherwise would mean reopening [ADR
