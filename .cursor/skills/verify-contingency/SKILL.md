...
- Agent View draft review shows Pending Decision kind, scope summary, and id as a read-only mirror. It has no `Authorize Verification Run` or `Approve Agent Flow` buttons.
