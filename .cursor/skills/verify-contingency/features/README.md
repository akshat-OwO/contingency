...
- [Workspace](./workspace.md) is the UI recipe for navigation, the Teaching Start/Stop capture boundary, Verification Runs, Interactive Runs, and persisted Run Summaries.
