...
- `agent-pending-decisions` relays verification authorization and approval through MCP while Agent View mirrors pending and resolved status without action buttons.
