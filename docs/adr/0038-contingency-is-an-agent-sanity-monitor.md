...
> Partly superseded by [ADR 0039](./0039-flow-skills-are-learned-from-temporary-teaching-recordings.md). The PlayByPlay pass, the Teaching Feed, and Agent Flow compilation and approval are removed; Teaching, Runs, and the unified Workspace remain.

> [ADR 0042](./0042-agent-controlled-teaching-setup.md) supersedes the user-only browser control rule during Teaching setup. Recording remains user-led.
