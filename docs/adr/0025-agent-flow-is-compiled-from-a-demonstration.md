...
> Superseded by [ADR 0039](./0039-flow-skills-are-learned-from-temporary-teaching-recordings.md). Contingency no longer compiles an Agent Flow from a Demonstration; a Flow Skill is learned from a Teaching Recording.
